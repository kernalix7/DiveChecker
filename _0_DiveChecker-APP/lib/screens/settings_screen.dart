...
class _SettingsScreenState extends State<SettingsScreen> {
            ...
            children: [
                        ...
                        return Column(
                          children: [
                            Divider(
                              ...
                              indent: WidgetSizes.dividerIndent,
              ...
              Consumer<SerialProvider>(
                builder: (context, serialProvider, _) {
                  ...
                  final deviceName =
                      serialProvider.deviceName ?? AppConfig.appName;
                  final shortSerial =
                      serialProvider.deviceSerial != null &&
                          serialProvider.deviceSerial!.length >= 4
                      ? serialProvider.deviceSerial!.substring(
                          serialProvider.deviceSerial!.length - 4,
                        )
                      : '';
                    ...
                    child: ListTile(
                      leading: Container(
                        ...
                        decoration: BoxDecoration(
                          color: isAuth
                              ? StatusColors.connected.withOpacity(
                                  Opacities.low,
                                )
      ...
      if (mounted) {
        if (result.success) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(
                '${l10n.restoreFailed}: ${result.errors.join(', ')}',
              ),
              backgroundColor: ScoreColors.poor,
            ),
          );
  ...
  void _showChangeNameDialog(
    ...
    final nameController = TextEditingController(
      text: serialProvider.deviceName ?? '',
    );
