...
const translations = {
    ...
    'faq.a18': { ko: '네! 다이브샵 및 다이빙 강사 분들과의 딜러 계약을 환영합니다. 도매 가격, 교육용 특별 할인 등 자세한 조건은 <a href="mailto:cs-divechecker@createch.kr">cs-divechecker@createch.kr</a>으로 문의해 주세요.', en: 'Yes! We welcome dealer partnerships with dive shops and instructors. For wholesale pricing and educational discounts, contact <a href="mailto:cs-divechecker@createch.kr">cs-divechecker@createch.kr</a>.', ja: 'Yes! We welcome dealer partnerships with dive shops and instructors. For wholesale pricing and educational discounts, contact <a href="mailto:cs-divechecker@createch.kr">cs-divechecker@createch.kr</a>.', zh: 'Yes! We welcome dealer partnerships with dive shops and instructors. For wholesale pricing and educational discounts, contact <a href="mailto:cs-divechecker@createch.kr">cs-divechecker@createch.kr</a>.', tw: 'Yes! We welcome dealer partnerships with dive shops and instructors. For wholesale pricing and educational discounts, contact <a href="mailto:cs-divechecker@createch.kr">cs-divechecker@createch.kr</a>.' },
    'faq.q19': { ko: '해외 배송이 가능한가요?', en: 'Do you ship internationally?', ja: '海外配送はできますか？', zh: '支持海外配送吗？', tw: '支持海外配送吗？' },
    'faq.a19': { ko: '현재 국내 배송만 지원하고 있습니다. 해외 배송은 준비 중이며, <a href="mailto:cs-divechecker@createch.kr">cs-divechecker@createch.kr</a>으로 문의해 주시면 개별적으로 안내드리겠습니다.', en: 'Currently domestic shipping only. International shipping is coming soon. Contact <a href="mailto:cs-divechecker@createch.kr">cs-divechecker@createch.kr</a> for individual arrangements.', ja: 'Currently domestic shipping only. International shipping is coming soon. Contact <a href="mailto:cs-divechecker@createch.kr">cs-divechecker@createch.kr</a> for individual arrangements.', zh: 'Currently domestic shipping only. International shipping is coming soon. Contact <a href="mailto:cs-divechecker@createch.kr">cs-divechecker@createch.kr</a> for individual arrangements.', tw: 'Currently domestic shipping only. International shipping is coming soon. Contact <a href="mailto:cs-divechecker@createch.kr">cs-divechecker@createch.kr</a> for individual arrangements.' },
