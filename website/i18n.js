...
const translations = {
    // ── PAGE ──
    'page.title': { ko: 'DiveChecker — 눈으로 보는 이퀄라이징', en: 'DiveChecker — See Your Equalization', ja: 'DiveChecker — イコライジングを目で見る', zh: 'DiveChecker — 用眼睛看均压', tw: 'DiveChecker — 用眼睛看均壓' },
    ...
    'nav.products': { ko: '제품', en: 'Products', ja: '製品', zh: '产品', tw: '產品' },
    ...
    'hero.title': { ko: '이퀄라이징,<br>이제 <span class="gradient-text">눈으로</span> 봅니다', en: 'See Your<br><span class="gradient-text">Equalization</span>', ja: 'イコライジングを<br><span class="gradient-text">「目」で見る</span>', zh: '用<span class="gradient-text">「眼睛」</span><br>看均压', tw: '用<span class="gradient-text">「眼睛」</span><br>看均壓' },
    'hero.desc': { ko: '감각이 아니라 <strong>데이터</strong>로 배웁니다.<br>100Hz 실시간 압력 센서 &middot; USB 무지연 &middot; 크로스플랫폼', en: 'Freediving equalization training with <strong>data</strong>, not guesswork.<br>100Hz real-time pressure sensor &middot; USB zero latency &middot; Cross-platform', ja: '感覚ではなく<strong>データ</strong>で学ぶフリーダイビング均圧トレーニング。<br>100Hzリアルタイム圧力センサー &middot; USBゼロレイテンシー &middot; クロスプラットフォーム', zh: '不靠感觉，用<strong>数据</strong>学习自由潜水均压训练。<br>100Hz实时压力传感器 &middot; USB零延迟 &middot; 跨平台', tw: '不靠感覺，用<strong>數據</strong>學習自由潛水均壓訓練。<br>100Hz實時壓力傳感器 &middot; USB零延遲 &middot; 跨平台' },
    ...
    'hero.stat-latency': { ko: '지연시간', en: 'Latency', ja: 'レイテンシー', zh: '延迟', tw: '延遲' },
    ...
    'problem.title': { ko: '이퀄라이징이 안 되면<br>결국 <span class="text-red">수업을 포기</span>하게 됩니다', en: 'Equalization failure leads to<br><span class="text-red">giving up lessons</span>', ja: 'イコライジングの失敗は<br><span class="text-red">レッスン断念</span>につながります', zh: '均压失败会导致<br><span class="text-red">放弃课程</span>', tw: '均壓失敗會導致<br><span class="text-red">放棄課程</span>' },
    'problem.1.title': { ko: '수업 포기', en: 'Dropout', ja: 'レッスン断念', zh: '放弃课程', tw: '放棄課程' },
    'problem.1.desc': { ko: '이퀄라이징이 안 되니 다음 레벨로 못 넘어가고, 수강료만 계속 빠져나가는 악순환.', en: 'Can\'t equalize, can\'t advance. A vicious cycle of wasted tuition fees.', ja: 'イコライジングができず次のレベルを断念。受講料だけが無駄になる悪循環。', zh: '因为无法均压而放弃下一级别。学费白白浪费的恶性循环。', tw: '因為無法均壓而放棄下一級別。學費白白浪費的惡性循環。' },
    'problem.2.title': { ko: '원인 불명', en: 'Unknown Cause', ja: '原因不明', zh: '原因不明', tw: '原因不明' },
    'problem.2.desc': { ko: '뭐가 문제인지도 모르고 같은 실수를 반복합니다. 연습이 아니라 시간 낭비예요.', en: 'Repeating the same mistakes without knowing what\'s wrong. Not practice — just wasted time.', ja: '何が間違っているかわからないまま同じミスを繰り返す。練習ではなく、ただの時間の無駄。', zh: '不知道哪里出了问题，却一直重复同样的错误。不是练习，而是浪费时间。', tw: '不知道哪裡出了問題，卻一直重複同樣的錯誤。不是練習，而是浪費時間。' },
    'problem.3.title': { ko: '건강 위험', en: 'Health Risk', ja: '健康リスク', zh: '健康风险', tw: '健康風險' },
    'problem.3.desc': { ko: '발살바를 무리하게 쓰면 고막이 손상되거나 역압착이 옵니다. 한 번 다치면 회복이 어려워요.', en: 'Eardrum damage and reverse squeeze from excessive Valsalva. Irreversible.', ja: '過度なバルサルバによる鼓膜損傷、リバーススクイーズ。取り返しがつきません。', zh: '过度的Valsalva导致鼓膜损伤、反向挤压。不可逆转。', tw: '過度的Valsalva導致鼓膜損傷、反向擠壓。不可逆轉。' },
    ...
    'solution.sub': { ko: '이퀄라이징 압력을 실시간으로 보여주는 단 하나의 장비', en: 'The only device that visualizes equalization pressure in real time', ja: 'イコライジング圧力をリアルタイムで可視化する唯一のデバイス', zh: '实时可视化均压压力的唯一设备', tw: '實時可視化均壓壓力的唯一設備' },

    // ── FEATURES ──
    'features.label': { ko: 'FEATURES', en: 'FEATURES', ja: 'FEATURES', zh: 'FEATURES', tw: 'FEATURES' },
    'features.title': { ko: '왜 다이브체커일까', en: 'Why DiveChecker', ja: 'なぜDiveCheckerなのか', zh: '为什么选择DiveChecker', tw: '為什么選擇DiveChecker' },
    'feat1.title': { ko: '실시간 압력 시각화', en: 'Real-time Pressure Visualization', ja: 'リアルタイム圧力可視化', zh: '实时压力可视化', tw: '實時壓力可視化' },
    'feat1.desc': { ko: '"더 세게" 같은 막연한 피드백은 이제 끝.<br>내 프렌젤이 정확히 몇 hPa인지 실시간으로 확인하고, 압력이 과하면 그 자리에서 시각 경고가 뜹니다.', en: 'No more vague feedback like "push harder."<br>See exactly how many hPa your Frenzel generates in real time. Visual alerts for excessive pressure.', ja: '「もっと強く」のような曖昧なフィードバックは終わり。<br>フレンゼルの圧力が正確に何hPaか、リアルタイムで確認できます。過度な圧力には即座に視覚警告。', zh: '告别"再用力一点"这样模糊的反馈。<br>实时确认您的Frenzel压力精确到几hPa。压力过大时立即视觉警告。', tw: '告別"再用力一點"這樣模糊的反饋。<br>實時確認您的Frenzel壓力精確到幾hPa。壓力過大時立即視覺警告。' },
    ...
    'usb.sub': { ko: '이퀄라이징 훈련에선 0.01초만 늦어도 피드백이 어긋납니다', en: 'In equalization training, 0.01s delay means wrong feedback', ja: 'イコライジング訓練で0.01秒の遅延は間違ったフィードバックです', zh: '在均压训练中，0.01秒的延迟就意味着错误的反馈', tw: '在均壓訓練中，0.01秒的延遲就意味着錯誤的反饋' },
    ...
    'usb.row2-bt': { ko: '매번 충전', en: 'Charging required', ja: '充電が必要', zh: '需要充电', tw: '需要充電' },
    'usb.row2-usb': { ko: 'USB로 바로 작동', en: 'USB powered', ja: 'USB給電', zh: 'USB供电', tw: 'USB供電' },
    ...
    'usb.row3-usb': { ko: '100% 안정적', en: '100% stable', ja: '100%安定接続', zh: '100%稳定连接', tw: '100%穩定連接' },
    'usb.row4': { ko: '호환성', en: 'Compatibility', ja: '互換性', zh: '兼容性', tw: '兼容性' },
    'usb.row4-bt': { ko: '기기마다 제각각', en: 'Varies by device', ja: 'デバイスにより異なる', zh: '因设备而异', tw: '因設備而異' },
    ...
    'how.step1.desc': { ko: '케이블 하나로 전원과 데이터가 한 번에 연결됩니다. 페어링 없이 꽂기만 하면 끝.', en: 'One cable for power + data. Just plug in — no complex pairing needed.', ja: 'ケーブル1本で電源+データ同時接続。複雑なペアリングなしで差すだけ。', zh: '一根线同时供电+传输数据。无需复杂配对，插上即可。', tw: '一根線同時供電+傳輸數據。無需復杂配對，插上即可。' },
    'how.step2.title': { ko: '앱 실행', en: 'Launch App', ja: 'アプリ起動', zh: '启动应用', tw: '啟動應用' },
    'how.step2.desc': { ko: 'QR코드로 앱을 받으면 디바이스를 알아서 인식합니다. 별도 설정은 필요 없어요.', en: 'Download via QR code, auto device detection. No setup needed.', ja: 'QRコードでアプリダウンロード、自動デバイス認識。設定不要。', zh: '扫描QR码下载应用，自动识别设备。无需设置。', tw: '掃描QR碼下載應用，自動識別設備。無需設置。' },
    'how.step3.title': { ko: '연습 시작', en: 'Start Training', ja: 'トレーニング開始', zh: '开始训练', tw: '開始訓練' },
    'how.step3.desc': { ko: '코에 대고 이퀄라이징하세요. 그래프가 그 순간 바로 답을 보여줍니다.', en: 'Place on your nose and equalize. Get instant feedback via real-time graphs.', ja: '鼻に当ててイコライジング。リアルタイムグラフで即座にフィードバック。', zh: '贴在鼻子上均压。通过实时图表立即获得反馈。', tw: '貼在鼻子上均壓。通過實時圖表立即獲得反饋。' },

    // ── TARGET ──
    'target.label': { ko: 'FOR YOU', en: 'FOR YOU', ja: 'FOR YOU', zh: 'FOR YOU', tw: 'FOR YOU' },
    'target.title': { ko: '이런 분들께 추천합니다', en: 'Who It\'s For', ja: 'こんな方におすすめです', zh: '适合这些人使用', tw: '適合這些人使用' },
    'target.1.title': { ko: '이퀄라이징이 잘 안 되시는 분', en: 'Struggling with Equalization', ja: 'イコライジングができない方', zh: '无法均压的人', tw: '無法均壓的人' },
    ...
    'target.2.title': { ko: '발살바에서 프렌젤로 넘어가는 분', en: 'Switching to Frenzel', ja: 'フレンゼル移行が難しい方', zh: '难以转换到Frenzel的人', tw: '難以轉換到Frenzel的人' },
    'target.2.desc': { ko: '두 기법의 차이를 그래프로 분명하게 확인', en: 'Verify Valsalva → Frenzel transition with graphs', ja: 'バルサルバ→フレンゼル移行をグラフで確認', zh: '通过图表确认Valsalva→Frenzel的转换', tw: '通過圖表確認Valsalva→Frenzel的轉換' },
    'target.3.title': { ko: '딥 다이버 / 머메이드', en: 'Deep & Mermaid Divers', ja: 'ディープ＆マーメイドダイバー', zh: '深潜和美人鱼潜水员', tw: '深潛和美人魚潛水員' },
    'target.3.desc': { ko: '마우스필과 핸즈프리 BTV까지 지상에서 훈련', en: 'Dry training for Mouthfill & BTV hands-free', ja: 'Mouthfill・BTV Hands-free陸上トレーニング', zh: 'Mouthfill・BTV Hands-free陆地训练', tw: 'Mouthfill・BTV Hands-free陸地訓練' },
    'target.4.title': { ko: '다이빙 강사님', en: 'Diving Instructors', ja: 'ダイビングインストラクター', zh: '潜水教练', tw: '潛水教練' },
    'target.4.desc': { ko: '학생에게 객관적인 그래프 피드백 제공', en: 'Provide precise graph-based feedback', ja: 'グラフに基づく正確なフィードバック提供', zh: '提供基于图表的精确反馈', tw: '提供基於圖表的精確反饋' },
    ...
    'price.sub': { ko: '한국에서 직접 설계·제조해 가격 거품을 걷어냈습니다', en: 'Designed & manufactured in Korea — no price markup', ja: '韓国設計・製造でコストを削減', zh: '韩国设计·制造，去除价格泡沫', tw: '韓國設计·製造，去除價格泡沫' },
    ...
    'trust.1.desc': { ko: '국가공인시험기관(KTC) 시험을 거쳐<br>KC 안전 인증을 받은 제품이에요', en: 'Tested by KTC (Korea Testing Certification)<br>and KC safety certified', ja: '国家公認試験機関(KTC)の試験を経て<br>KC安全認証を取得した製品です', zh: '经韩国国家认证机构(KTC)检测<br>获得KC安全认证的产品', tw: '經韓國國家認證機構(KTC)檢測<br>獲得KC安全認證的產品' },
    'trust.2.title': { ko: 'Made in Korea', en: 'Made in Korea', ja: 'Made in Korea', zh: 'Made in Korea', tw: 'Made in Korea' },
    'trust.2.desc': { ko: '설계부터 제조까지 100% 한국에서<br>빠른 A/S와 꾸준한 업데이트', en: '100% designed & manufactured in Korea<br>Fast A/S and continuous updates', ja: '設計から製造まで100%韓国国内<br>迅速なA/Sと継続的なアップデート', zh: '从设计到制造100%韩国国内<br>快速售后和持续更新', tw: '從設计到製造100%韓國國內<br>快速售後和持續更新' },
    ...
    'trust.4.desc': { ko: '불필요한 플라스틱은 빼고<br>환경을 생각한 포장재로 배송됩니다', en: 'No unnecessary plastic<br>Eco-conscious packaging materials', ja: '不要なプラスチックなし<br>環境を考えた包装材を使用', zh: '无多余塑料<br>使用环保包装材料', tw: '無多余塑料<br>使用環保包裝材料' },

    // ── CLOSING ──
    'closing.title': { ko: '프렌젤이 안 되는 게 아니에요.<br>그동안 <span class="gradient-text glow-text">확인할 방법</span>이 없었을 뿐이죠.', en: 'It\'s not that you can\'t Frenzel.<br>You just had <span class="gradient-text glow-text">no way to see it</span>.', ja: 'フレンゼルができないのではありません。<br><span class="gradient-text glow-text">確認する方法</span>がなかっただけです。', zh: '不是您做不到Frenzel，<br>只是以前没有<span class="gradient-text glow-text">确认的方法</span>而已。', tw: '不是您做不到Frenzel，<br>只是以前沒有<span class="gradient-text glow-text">確認的方法</span>而已。' },
    'closing.sub': { ko: '다이브체커와 함께라면, 오늘부터 수심이 달라집니다.', en: 'With DiveChecker, your depth changes starting today.', ja: 'DiveCheckerと共に、今日から深度が変わります。', zh: '与DiveChecker一起，从今天开始改变深度。', tw: '與DiveChecker一起，從今天開始改變深度。' },
    ...
    'dealer.title': { ko: '다이브샵 대표님과 강사님께', en: 'For Dive Shop Owners & Instructors', ja: 'ダイブショップオーナー・インストラクターの皆様へ', zh: '致潜水店店主、教练', tw: '致潛水店店主、教練' },
    'dealer.desc': { ko: '다이브체커는 <strong>다이브샵</strong>과 <strong>다이빙 강사</strong>분들과의 딜러 계약을 환영합니다.<br>매장에는 새로운 가치를, 학생에게는 더 나은 피드백을 더해 드릴게요.', en: 'DiveChecker welcomes dealer partnerships with <strong>dive shops</strong> and <strong>diving instructors</strong>.<br>Add new value to your shop and better feedback for your students.', ja: 'DiveCheckerは<strong>ダイブショップ</strong>および<strong>ダイビングインストラクター</strong>とのディーラー契約を歓迎します。<br>店舗に新たな価値を、受講生により良いフィードバックを。', zh: 'DiveChecker欢迎与<strong>潜水店</strong>和<strong>潜水教练</strong>建立经销合作。<br>为门店增添新价值，为学员提供更好的反馈。', tw: 'DiveChecker歡迎與<strong>潛水店</strong>和<strong>潛水教練</strong>建立經銷合作。<br>為門店增添新價值，為學員提供更好的反饋。' },
    'dealer.note': { ko: '딜러 조건, 도매 가격, 교육용 할인 등 자세한 내용은 이메일로 문의해 주세요.', en: 'For dealer terms, wholesale pricing, and educational discounts, please contact us via email.', ja: 'ディーラー条件、卸売価格、教育用特別割引など、詳しくはメールでお問い合わせください。', zh: '经销条件、批发价格、教育特别折扣等详情，请通过邮件联系我们。', tw: '經銷條件、批發價格、教育特別折扣等詳情，請通過郵件聯繫我們。' },

    // ── FOOTER ──
    'footer.tagline': { ko: '눈으로 보는 이퀄라이징', en: 'See Your Equalization', ja: 'イコライジングを目で見る', zh: '用眼睛看均压', tw: '用眼睛看均壓' },
    ...
    // ═══ VENT PAGE ═══
    'vent.page-title': { ko: 'DiveChecker Vent — 풍선으로 배우는 이퀄라이징', en: 'DiveChecker Vent — Balloon Equalization Trainer', ja: 'DiveChecker Vent — バルーン耳管トレーナー', zh: 'DiveChecker Vent — 气球均压训练器', tw: 'DiveChecker Vent — 氣球均壓訓練器' },
    ...
    'vent.hero.title': { ko: '물 없이도 가능한<br><span class="gradient-text">이관 훈련</span>', en: 'Train your<br><span class="gradient-text">Eustachian tubes</span><br>without water', ja: '水なしで鍛える<br><span class="gradient-text">耳管通気</span>', zh: '无需水<br>训练<span class="gradient-text">咽鼓管通气</span>', tw: '無需水<br>訓練<span class="gradient-text">耳咽管通氣</span>' },
    'vent.hero.desc': { ko: '정밀하게 교정된 <strong>역압 풍선</strong>이 발살바를 막아, 자연스럽게 프렌젤과 마우스필을 익히게 만듭니다.<br>풍선 크기로 보는 시각 피드백 &middot; 어디서나 가능한 지상 훈련', en: 'A pressure-calibrated <strong>balloon</strong> blocks Valsalva and forces correct Frenzel / Mouthfill.<br>Visual feedback by balloon size &middot; Dry training, anywhere', ja: '精密に校正された<strong>逆圧バルーン</strong>がバルサルバを防ぎ、フレンゼル・マウスフィルを強制的に教えます。<br>バルーンの大きさで見える視覚フィードバック &middot; どこでも陸上トレーニング', zh: '精密校准的<strong>反压气球</strong>阻止Valsalva，强制学习Frenzel・Mouthfill。<br>气球大小作为视觉反馈 &middot; 随时随地干训', tw: '精密校準的<strong>反壓氣球</strong>阻止Valsalva，強制學習Frenzel・Mouthfill。<br>氣球大小作為視覺反饋 &middot; 隨時隨地乾訓' },
    'vent.hero.cta-buy': { ko: '지금 구매하기', en: 'Buy Now', ja: '今すぐ購入', zh: '立即购买', tw: '立即購買' },
    'vent.hero.cta-learn': { ko: '작동 원리', en: 'How It Works', ja: '仕組みを見る', zh: '工作原理', tw: '工作原理' },
    'vent.hero.stat1-num': { ko: '0', en: '0', ja: '0', zh: '0', tw: '0' },
    'vent.hero.stat1-label': { ko: '물 없이', en: 'Water needed', ja: '水不要', zh: '需要水', tw: '需要水' },
    'vent.hero.stat2-num': { ko: '100+', en: '100+', ja: '100+', zh: '100+', tw: '100+' },
    'vent.hero.stat2-label': { ko: '풍선당 사이클', en: 'Cycles per balloon', ja: 'バルーンあたりサイクル', zh: '每个气球周期', tw: '每個氣球週期' },
    'vent.hero.stat3-num': { ko: '3~5', en: '3~5', ja: '3~5', zh: '3~5', tw: '3~5' },
    'vent.hero.stat3-label': { ko: '하루 권장 횟수', en: 'Daily sessions', ja: '1日の推奨セッション', zh: '每日建议次数', tw: '每日建議次數' },

    // ── PROBLEM ──
    'vent.problem.title': { ko: '풀에 갈 수 없을 땐<br><span class="text-red">실패도 늦게 알게</span> 됩니다', en: 'When you can\'t reach the pool,<br><span class="text-red">failure is found too late</span>', ja: 'プールに行けない時、<br><span class="text-red">失敗は手遅れで気づきます</span>', zh: '无法去泳池时，<br><span class="text-red">失败为时已晚</span>', tw: '無法去泳池時，<br><span class="text-red">失敗為時已晚</span>' },
    'vent.problem.1.title': { ko: '잘못 굳은 발살바 습관', en: 'Wrong Valsalva habit', ja: '間違ったバルサルバの習慣', zh: '错误的Valsalva习惯', tw: '錯誤的Valsalva習慣' },
    'vent.problem.1.desc': { ko: '코 막고 세게 부는 습관이 굳어버리면 깊은 곳에선 절대 안 통합니다. 프렌젤과 마우스필은 완전히 다른 근육 패턴이에요.', en: 'Pinching your nose and pushing hard does not scale to depth. Frenzel and Mouthfill are different muscle patterns entirely.', ja: '鼻を塞いで強く吹く癖は深いところでは通用しません。フレンゼル・マウスフィルは全く別の筋肉の使い方です。', zh: '捏鼻硬吹的习惯在深处行不通。Frenzel・Mouthfill是完全不同的肌肉用法。', tw: '捏鼻硬吹的習慣在深處行不通。Frenzel・Mouthfill是完全不同的肌肉用法。' },
    'vent.problem.2.title': { ko: '연습할 곳이 없다', en: 'Nowhere to practice', ja: '練習する場所がない', zh: '没地方练习', tw: '沒地方練習' },
    'vent.problem.2.desc': { ko: '풀이나 바다에 가야만 이퀄라이징 연습이 된다고 생각하세요? 사실 90%는 지상에서 익혀야 합니다.', en: 'Think you need a pool or the ocean to train equalization? 90% of mastery happens on dry land.', ja: 'プールや海でしかイコライジング練習できないと思っていますか？90%は陸上でマスターすべきです。', zh: '以为只能在泳池或海中练均压？90%的掌握应该在陆地完成。', tw: '以為只能在泳池或海中練均壓？90%的掌握應該在陸地完成。' },
    'vent.problem.3.title': { ko: '피드백이 없다', en: 'No feedback', ja: 'フィードバック不足', zh: '没有反馈', tw: '沒有反饋' },
    'vent.problem.3.desc': { ko: '"제대로 한 거 맞나?"를 확인할 객관적인 신호가 없습니다. 귀가 펑 하든 안 하든 강사도 학생도 추측만 할 뿐이에요.', en: 'No objective signal for "did it work?" Pop or no pop, both instructor and student are just guessing.', ja: '「うまくいった？」を測る客観的な信号がありません。耳がポンと鳴ろうがなかろうが、講師も生徒も推測するだけです。', zh: '没有客观信号判断"成功了吗？"。无论耳朵是否啵的一声，教练和学生都只能猜测。', tw: '沒有客觀訊號判斷「成功了嗎？」。無論耳朵是否啵的一聲，教練和學生都只能猜測。' },

    // ── SOLUTION ──
    'vent.solution.title': { ko: '풍선이<br><span class="gradient-text">선생님</span>이 됩니다', en: 'The balloon<br>becomes your <span class="gradient-text">teacher</span>', ja: 'バルーンが<br><span class="gradient-text">先生</span>になります', zh: '气球<br>成为<span class="gradient-text">老师</span>', tw: '氣球<br>成為<span class="gradient-text">老師</span>' },
    'vent.solution.sub': { ko: 'Otovent식 자가 통기 훈련을 다이브체커 방식으로 새로 만들었습니다', en: 'Autoinflation training reimagined with the DiveChecker design language', ja: 'Otovent方式の自己通気トレーニングをDiveCheckerのデザイン言語で再構築しました', zh: '将Otovent式自动充气训练以DiveChecker的设计语言重新打造', tw: '將Otovent式自動充氣訓練以DiveChecker的設計語言重新打造' },

    // ── FEATURES ──
    'vent.feat.title': { ko: '왜 다이브체커 벤트일까', en: 'Why DiveChecker Vent', ja: 'なぜDiveChecker Ventなのか', zh: '为什么选择DiveChecker Vent', tw: '為什麼選擇DiveChecker Vent' },
    'vent.feat1.title': { ko: '발살바를 막아주는 역압', en: 'Back-pressure that blocks Valsalva', ja: 'バルサルバを遮断する逆圧', zh: '阻断Valsalva的反压', tw: '阻斷Valsalva的反壓' },
    'vent.feat1.desc': { ko: '풍선이 일정 압력 이상에서만 부풀도록 정밀하게 교정되어 있어, 세게 부는 발살바로는 풍선이 커지지 않습니다.<br>혀와 후두로 압력을 짜내는 <strong>프렌젤</strong>만이 풍선을 키울 수 있어요.', en: 'The balloon is calibrated to expand only above a threshold, so brute-force Valsalva won\'t inflate it.<br>Only the tongue-and-larynx compression of <strong>Frenzel</strong> can grow it.', ja: 'バルーンは一定圧力以上でのみ膨らむよう校正されており、強く吹くバルサルバでは膨らみません。<br>舌と喉頭で絞り出す<strong>フレンゼル</strong>だけがバルーンを膨らませられます。', zh: '气球被校准为仅在阈值以上才膨胀，蛮力Valsalva无法吹起。<br>只有用舌头和喉部挤压的<strong>Frenzel</strong>才能让它变大。', tw: '氣球被校準為僅在閾值以上才膨脹，蠻力Valsalva無法吹起。<br>只有用舌頭和喉部擠壓的<strong>Frenzel</strong>才能讓它變大。' },
    'vent.feat1.tag1': { ko: '프렌젤 강제 유도', en: 'Forced Frenzel', ja: '強制フレンゼル', zh: '强制Frenzel', tw: '強制Frenzel' },
    'vent.feat1.tag2': { ko: '발살바 차단', en: 'Valsalva block', ja: 'バルサルバ遮断', zh: 'Valsalva阻断', tw: 'Valsalva阻斷' },
    'vent.feat1.tag3': { ko: '근육 패턴 교정', en: 'Muscle re-pattern', ja: '筋肉パターン矯正', zh: '肌肉模式矫正', tw: '肌肉模式矯正' },
    'vent.feat2.title': { ko: '풍선 크기 = 시각 피드백', en: 'Balloon size = visual feedback', ja: 'バルーンサイズ＝視覚フィードバック', zh: '气球大小＝视觉反馈', tw: '氣球大小＝視覺反饋' },
    'vent.feat2.desc': { ko: '"제대로 했나?"는 이제 사라집니다. 풍선이 자몽 크기로 부풀면 성공.<br>학생도, 강사도, 옆에서 보는 사람도 동시에 결과를 봅니다.', en: 'No more "did it work?" When the balloon swells to grapefruit size, you succeeded.<br>Student, instructor, and bystander all see the result at the same time.', ja: '「うまくいった？」が消えます。バルーンがグレープフルーツ大に膨らめば成功。<br>生徒も講師も、横で見ている人も同時に結果を見ます。', zh: '"成功了吗？"消失了。气球膨胀到葡萄柚大小即为成功。<br>学生、教练、旁观者同时看到结果。', tw: '「成功了嗎？」消失了。氣球膨脹到葡萄柚大小即為成功。<br>學生、教練、旁觀者同時看到結果。' },
    'vent.feat2.tag1': { ko: '시각 피드백', en: 'Visual feedback', ja: '視覚フィードバック', zh: '视觉反馈', tw: '視覺反饋' },
    'vent.feat2.tag2': { ko: '명확한 성공 기준', en: 'Clear success criterion', ja: '明確な成功基準', zh: '明确的成功标准', tw: '明確的成功標準' },
    'vent.feat2.tag3': { ko: '교습에 최적', en: 'Instructor friendly', ja: '指導向け', zh: '便于教学', tw: '便於教學' },
    'vent.feat3.title': { ko: '어디서나 가능한 지상 훈련', en: 'Dry training, anywhere', ja: 'どこでも陸上トレーニング', zh: '随时随地干训', tw: '隨時隨地乾訓' },
    'vent.feat3.desc': { ko: '비행기 안, 출장지 호텔, 다이빙 가는 차 안에서. 풀이나 바다 없이 매일 5분.<br>마우스필 진입까지의 모든 단계를 지상에서 다집니다.', en: 'On a plane, in a hotel, in your car before a dive — five minutes a day without water.<br>Drill every step up to Mouthfill entry on dry land.', ja: '飛行機内、出張先のホテル、ダイビング前の車内。プールも海もなしで毎日5分。<br>マウスフィル導入までの全ステップを陸上で仕上げます。', zh: '飞机上、出差酒店里、潜水前的车里——每天5分钟，无需水。<br>在陆地上完成到Mouthfill入门的每一步。', tw: '飛機上、出差飯店裡、潛水前的車裡——每天5分鐘，無需水。<br>在陸地上完成到Mouthfill入門的每一步。' },
    'vent.feat3.tag1': { ko: '휴대성', en: 'Portable', ja: '携帯性', zh: '便携', tw: '便攜' },
    'vent.feat3.tag2': { ko: '5분 루틴', en: '5-min routine', ja: '5分ルーティン', zh: '5分钟惯例', tw: '5分鐘慣例' },
    'vent.feat3.tag3': { ko: '매일 가능', en: 'Daily-ready', ja: '毎日OK', zh: '每天可用', tw: '每天可用' },
    'vent.feat4.title': { ko: '센서와 함께 쓰는 트레이닝 키트', en: 'Pairs with the sensor — a complete kit', ja: 'センサーと組み合わせる完全キット', zh: '与传感器配对的完整套件', tw: '與感測器配對的完整套件' },
    'vent.feat4.desc': { ko: 'Vent로 <strong>근육</strong>을 가르치고, DiveChecker 센서로 <strong>압력 곡선</strong>을 측정합니다.<br>두 제품을 함께 쓰면 학습 사이클이 닫혀요: 한다 → 측정한다 → 고친다.', en: 'Vent teaches the <strong>muscles</strong>, the DiveChecker sensor measures the <strong>pressure curve</strong>.<br>Use both and the loop closes: do → measure → fix.', ja: 'Ventで<strong>筋肉</strong>を教え、DiveCheckerセンサーで<strong>圧力曲線</strong>を測定します。<br>二つを併用すれば学習サイクルが閉じます：実行→測定→修正。', zh: 'Vent教导<strong>肌肉</strong>，DiveChecker传感器测量<strong>压力曲线</strong>。<br>两者配合形成学习闭环：做→测→改。', tw: 'Vent教導<strong>肌肉</strong>，DiveChecker感測器測量<strong>壓力曲線</strong>。<br>兩者配合形成學習閉環：做→測→改。' },
    'vent.feat4.tag1': { ko: '센서 연동', en: 'Sensor pairing', ja: 'センサー連携', zh: '传感器配合', tw: '感測器配合' },
    'vent.feat4.tag2': { ko: '학습 폐루프', en: 'Closed loop', ja: '学習クローズドループ', zh: '学习闭环', tw: '學習閉環' },
    'vent.feat4.tag3': { ko: '키트 번들', en: 'Kit bundle', ja: 'キットバンドル', zh: '套件捆绑', tw: '套件綑綁' },

    // ── HOW IT WORKS ──
    'vent.how.label': { ko: 'HOW IT WORKS', en: 'HOW IT WORKS', ja: 'HOW IT WORKS', zh: 'HOW IT WORKS', tw: 'HOW IT WORKS' },
    'vent.how.title': { ko: '풍선이 이관을 여는 원리', en: 'How the balloon opens your tubes', ja: 'バルーンが耳管を開く仕組み', zh: '气球如何打开咽鼓管', tw: '氣球如何打開耳咽管' },
    'vent.how.sub': { ko: '발살바를 막고 코로 들어가는 압력을 정밀하게 제한하면, 몸이 자연스럽게 프렌젤로 전환됩니다', en: 'Block Valsalva and meter the nasal pressure, and the body naturally switches to Frenzel', ja: 'バルサルバを遮断し鼻からの圧力を精密に制限すると、身体は自然にフレンゼルへ切り替わります', zh: '阻断Valsalva并精密限制鼻腔压力，身体会自然切换到Frenzel', tw: '阻斷Valsalva並精密限制鼻腔壓力，身體會自然切換到Frenzel' },
    'vent.how.s1.title': { ko: '한쪽 콧구멍에 노즈피스 밀착', en: 'Seal the nose piece on one nostril', ja: 'ノーズピースを片方の鼻孔に密着', zh: '将鼻塞贴紧一侧鼻孔', tw: '將鼻塞貼緊一側鼻孔' },
    'vent.how.s1.desc': { ko: '반대쪽 콧구멍은 손가락으로 막아주세요. 캡 끝의 노즈피스에 풍선이 단단히 끼워졌는지 확인합니다.', en: 'Pinch the opposite nostril shut. Make sure the balloon is firmly seated on the nose piece end of the cap.', ja: '反対側の鼻孔は指で塞ぎます。バルーンが膨らむようキャップ先端のノーズピースに正確に取り付けてください。', zh: '用手指捏住另一侧鼻孔。确保气球紧固在鼻塞末端。', tw: '用手指捏住另一側鼻孔。確保氣球緊固在鼻塞末端。' },
    'vent.how.s2.title': { ko: '입은 닫고 코로만 압력 만들기', en: 'Mouth closed — generate pressure through the nose', ja: '口は閉じて鼻からのみ圧力生成', zh: '闭口——仅通过鼻子产生压力', tw: '閉口——僅通過鼻子產生壓力' },
    'vent.how.s2.desc': { ko: '발살바로는 풍선이 안 부풉니다. 혀를 입천장으로 밀어 인후 공간을 좁히는 <strong>프렌젤 동작</strong>이 필요해요.', en: 'Valsalva won\'t inflate it. You need a <strong>Frenzel motion</strong> — tongue pressing the palate and squeezing the throat space.', ja: 'バルサルバでは膨らみません。舌を口蓋に押し付け喉の空間を狭める<strong>フレンゼルの動作</strong>が必要です。', zh: 'Valsalva无法吹起。需要<strong>Frenzel动作</strong>——舌头顶住上颚挤压喉部空间。', tw: 'Valsalva無法吹起。需要<strong>Frenzel動作</strong>——舌頭頂住上顎擠壓喉部空間。' },
    'vent.how.s3.title': { ko: '풍선이 자몽 크기면 성공', en: 'Grapefruit size = success', ja: 'バルーンがグレープフルーツ大なら成功', zh: '气球到葡萄柚大小＝成功', tw: '氣球到葡萄柚大小＝成功' },
    'vent.how.s3.desc': { ko: '한 번에 2~3초씩, 양쪽 콧구멍을 번갈아 5세트. 매일 반복하면 근육 패턴이 자리 잡습니다.', en: 'Hold each inflation 2~3 seconds, alternate nostrils, 5 sets. Daily repetition builds the muscle pattern.', ja: '1回2〜3秒、左右の鼻孔を交互に5セット。毎日繰り返すと筋肉パターンが定着します。', zh: '每次保持2~3秒，左右鼻孔交替，5组。每天重复使肌肉模式形成。', tw: '每次保持2~3秒，左右鼻孔交替，5組。每天重複使肌肉模式形成。' },

    // ── COMPARISON ──
    'vent.cmp.label': { ko: 'COMPARISON', en: 'COMPARISON', ja: 'COMPARISON', zh: 'COMPARISON', tw: 'COMPARISON' },
    'vent.cmp.title': { ko: '왜 그냥 풍선이 아니라 <span class="gradient-text">교정된</span> 풍선일까', en: 'Why a <span class="gradient-text">calibrated</span> balloon, not just any balloon', ja: 'なぜただの風船ではなく<span class="gradient-text">校正された</span>バルーンか', zh: '为什么是<span class="gradient-text">校准</span>的气球，而非随便一个', tw: '為什麼是<span class="gradient-text">校準</span>的氣球，而非隨便一個' },
    'vent.cmp.sub': { ko: '교정되지 않은 풍선은 발살바로도 부풀어 잘못된 습관을 강화시킵니다', en: 'An uncalibrated balloon inflates with Valsalva too — reinforcing bad habits', ja: '校正されていない風船はバルサルバでも膨らみ、悪い習慣を強化します', zh: '未校准的气球Valsalva也能吹起，反而强化坏习惯', tw: '未校準的氣球Valsalva也能吹起，反而強化壞習慣' },
    ...
    'vent.cmp.row1-vent': { ko: '정밀 교정된 임계값', en: 'Calibrated threshold', ja: '校正された閾値', zh: '校准阈值', tw: '校準閾值' },
    'vent.cmp.row2': { ko: '풍선 일관성', en: 'Balloon consistency', ja: 'バルーン一貫性', zh: '气球一致性', tw: '氣球一致性' },
    ...
    'vent.cmp.row3': { ko: '노즈피스', en: 'Nose piece', ja: 'ノーズピース', zh: '鼻塞', tw: '鼻塞' },
    'vent.cmp.row3-diy': { ko: '없음 (직접 입에 묾)', en: 'None (mouthed directly)', ja: 'なし（直接口でくわえる）', zh: '无（直接用口）', tw: '無（直接用口）' },
    'vent.cmp.row3-vent': { ko: '인체공학 실리콘', en: 'Ergonomic silicone', ja: '人体工学シリコン', zh: '人体工学硅胶', tw: '人體工學矽膠' },
    'vent.cmp.row4': { ko: '재사용성', en: 'Reusability', ja: '再利用性', zh: '可重复使用', tw: '可重複使用' },
    'vent.cmp.row4-diy': { ko: '한 번 쓰면 늘어남', en: 'Stretches after one use', ja: '一度で伸びる', zh: '一次用就松', tw: '一次用就鬆' },
    'vent.cmp.row4-vent': { ko: '교체 풍선 다수 동봉', en: 'Multiple replacement balloons included', ja: '交換用バルーン多数同梱', zh: '附多个备用气球', tw: '附多個備用氣球' },
    'vent.cmp.row5': { ko: '센서 연동', en: 'Sensor integration', ja: 'センサー連携', zh: '传感器联动', tw: '感測器聯動' },
    'vent.cmp.row5-diy': { ko: '없음', en: 'None', ja: 'なし', zh: '无', tw: '無' },
    'vent.cmp.row5-vent': { ko: 'DiveChecker와 함께', en: 'Pairs with DiveChecker', ja: 'DiveCheckerと併用', zh: '与DiveChecker配合', tw: '與DiveChecker配合' },

    // ── BUNDLE CALLOUT ──
    'vent.bundle.label': { ko: 'BETTER TOGETHER', en: 'BETTER TOGETHER', ja: 'BETTER TOGETHER', zh: 'BETTER TOGETHER', tw: 'BETTER TOGETHER' },
    'vent.bundle.title': { ko: '센서와 함께 쓰면<br>학습 사이클이 닫힙니다', en: 'Pair with the sensor<br>and the loop closes', ja: 'センサーと一緒に使えば<br>学習サイクルが閉じます', zh: '与传感器配合<br>形成学习闭环', tw: '與感測器配合<br>形成學習閉環' },
    'vent.bundle.do': { ko: 'DO', en: 'DO', ja: 'DO', zh: 'DO', tw: 'DO' },
    'vent.bundle.do-desc': { ko: 'Vent로 프렌젤 동작 수행', en: 'Perform Frenzel with Vent', ja: 'Ventでフレンゼル実施', zh: '用Vent执行Frenzel', tw: '用Vent執行Frenzel' },
    'vent.bundle.measure': { ko: 'MEASURE', en: 'MEASURE', ja: 'MEASURE', zh: 'MEASURE', tw: 'MEASURE' },
    'vent.bundle.measure-desc': { ko: 'DiveChecker 센서로 압력 곡선 측정', en: 'Measure the pressure curve with the DiveChecker sensor', ja: 'DiveCheckerセンサーで圧力曲線測定', zh: '用DiveChecker传感器测量压力曲线', tw: '用DiveChecker感測器測量壓力曲線' },
    'vent.bundle.fix': { ko: 'FIX', en: 'FIX', ja: 'FIX', zh: 'FIX', tw: 'FIX' },
    'vent.bundle.fix-desc': { ko: '앱이 분석한 점수를 보고 동작 교정', en: 'Read the app\'s scores and correct your motion', ja: 'アプリが分析したスコアを見て動作を修正', zh: '查看应用分析的分数纠正动作', tw: '查看應用分析的分數糾正動作' },
    'vent.bundle.cta': { ko: 'DiveChecker 센서 살펴보기', en: 'View DiveChecker sensor', ja: 'DiveCheckerセンサーを見る', zh: '查看DiveChecker传感器', tw: '查看DiveChecker感測器' },

    // ── SPECS ──
    'vent.specs.label': { ko: 'SPECIFICATIONS', en: 'SPECIFICATIONS', ja: 'SPECIFICATIONS', zh: 'SPECIFICATIONS', tw: 'SPECIFICATIONS' },
    'vent.specs.title': { ko: '제원', en: 'Specifications', ja: '仕様', zh: '规格', tw: '規格' },
    'vent.specs.unit-title': { ko: '본체 (Cap)', en: 'Main Unit (Cap)', ja: '本体（キャップ）', zh: '主体（Cap）', tw: '主體（Cap）' },
    'vent.specs.material': { ko: '재질', en: 'Material', ja: '素材', zh: '材质', tw: '材質' },
    'vent.specs.material-val': { ko: '식품등급 ABS + 실리콘 노즈피스', en: 'Food-grade ABS + silicone nose piece', ja: '食品グレードABS + シリコンノーズピース', zh: '食品级ABS + 硅胶鼻塞', tw: '食品級ABS + 矽膠鼻塞' },
    'vent.specs.size': { ko: '크기', en: 'Dimensions', ja: 'サイズ', zh: '尺寸', tw: '尺寸' },
    'vent.specs.size-val': { ko: '약 60 × 60 × 105 mm', en: '~60 × 60 × 105 mm', ja: '約60 × 60 × 105 mm', zh: '约60 × 60 × 105 mm', tw: '約60 × 60 × 105 mm' },
    'vent.specs.weight': { ko: '무게', en: 'Weight', ja: '重量', zh: '重量', tw: '重量' },
    'vent.specs.weight-val': { ko: '약 45 g', en: '~45 g', ja: '約45 g', zh: '约45 g', tw: '約45 g' },
    'vent.specs.color': { ko: '색상', en: 'Color', ja: 'カラー', zh: '颜色', tw: '顏色' },
    'vent.specs.color-val': { ko: '매트 블랙', en: 'Matte black', ja: 'マットブラック', zh: '哑光黑', tw: '霧黑' },

    'vent.specs.balloon-title': { ko: '풍선 (Balloon)', en: 'Balloon', ja: 'バルーン', zh: '气球', tw: '氣球' },
    'vent.specs.balloon-mat': { ko: '재질', en: 'Material', ja: '素材', zh: '材质', tw: '材質' },
    'vent.specs.balloon-mat-val': { ko: '의료급 라텍스 (라텍스 알러지 주의)', en: 'Medical-grade latex (latex allergy advisory)', ja: '医療グレードラテックス（ラテックスアレルギー注意）', zh: '医用级乳胶（乳胶过敏者注意）', tw: '醫用級乳膠（乳膠過敏者注意）' },
    'vent.specs.balloon-pres': { ko: '시작 압력', en: 'Threshold pressure', ja: '始動圧力', zh: '起始压力', tw: '起始壓力' },
    'vent.specs.balloon-pres-val': { ko: '약 16 kPa (120 mmHg)', en: '~16 kPa (120 mmHg)', ja: '約16 kPa (120 mmHg)', zh: '约16 kPa (120 mmHg)', tw: '約16 kPa (120 mmHg)' },
    'vent.specs.balloon-life': { ko: '풍선당 수명', en: 'Cycles per balloon', ja: 'バルーンあたり寿命', zh: '每个气球寿命', tw: '每個氣球壽命' },
    'vent.specs.balloon-life-val': { ko: '약 100 사이클', en: '~100 cycles', ja: '約100サイクル', zh: '约100次', tw: '約100次' },

    'vent.specs.use-title': { ko: '사용 (Use)', en: 'Use', ja: '使用', zh: '使用', tw: '使用' },
    'vent.specs.audience': { ko: '대상', en: 'For', ja: '対象', zh: '对象', tw: '對象' },
    'vent.specs.audience-val': { ko: '12세 이상 / 프리다이버, 스쿠버, 비행 자주 하시는 분', en: '12+ / freedivers, scuba divers, frequent flyers', ja: '12歳以上 / フリーダイバー・スキューバ・頻繁に飛行する方', zh: '12岁以上 / 自由潜水・水肺・常飞旅客', tw: '12歲以上 / 自由潛水・水肺・常飛旅客' },
    'vent.specs.daily': { ko: '권장 빈도', en: 'Recommended frequency', ja: '推奨頻度', zh: '建议频率', tw: '建議頻率' },
    'vent.specs.daily-val': { ko: '하루 3~5세션, 매 세션 양쪽 5회', en: '3~5 sessions/day, 5 reps each side', ja: '1日3〜5セッション、各5回ずつ両側', zh: '每天3~5次，每次每侧5次', tw: '每天3~5次，每次每側5次' },
    'vent.specs.cleaning': { ko: '세척', en: 'Cleaning', ja: '洗浄', zh: '清洁', tw: '清潔' },
    'vent.specs.cleaning-val': { ko: '미지근한 비눗물로 세척한 뒤 자연 건조', en: 'Wash in lukewarm soapy water, air dry', ja: 'ぬるま湯と石鹸で洗浄、自然乾燥', zh: '温水加肥皂清洗，自然晾干', tw: '溫水加肥皂清洗，自然晾乾' },

    // ── PACKAGE ──
    'vent.pkg.label': { ko: 'PACKAGE', en: 'PACKAGE', ja: 'PACKAGE', zh: 'PACKAGE', tw: 'PACKAGE' },
    'vent.pkg.title': { ko: '패키지 구성', en: 'Package Contents', ja: 'パッケージ内容', zh: '包装内容', tw: '包裝內容' },
    'vent.pkg.item1': { ko: 'DiveChecker Vent 본체 ×1', en: 'DiveChecker Vent unit ×1', ja: 'DiveChecker Vent本体 ×1', zh: 'DiveChecker Vent主体 ×1', tw: 'DiveChecker Vent主體 ×1' },
    'vent.pkg.item2': { ko: '교체용 풍선 ×5', en: 'Replacement balloons ×5', ja: '交換用バルーン ×5', zh: '备用气球 ×5', tw: '備用氣球 ×5' },
    'vent.pkg.item3': { ko: '휴대 파우치', en: 'Carry pouch', ja: '携帯ポーチ', zh: '便携袋', tw: '便攜袋' },
    'vent.pkg.item4': { ko: '사용 설명서', en: 'User manual', ja: '取扱説明書', zh: '用户手册', tw: '使用手冊' },

    // ── PRICING ──
    'vent.price.label': { ko: 'PRICING', en: 'PRICING', ja: 'PRICING', zh: 'PRICING', tw: 'PRICING' },
    'vent.price.sub': { ko: '한국에서 직접 설계·제조·판매', en: 'Designed, made, and sold direct from Korea', ja: '韓国で設計・製造・直販', zh: '韩国设计·制造·直销', tw: '韓國設計·製造·直銷' },
    'vent.price.badge1': { ko: '의료급 라텍스 풍선', en: 'Medical-grade latex', ja: '医療グレードラテックス', zh: '医用级乳胶', tw: '醫用級乳膠' },
